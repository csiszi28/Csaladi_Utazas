    ...
    <div className="space-y-3 border-t pt-3">
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          rows={2}
          autoComplete="off"
          className="border-input bg-transparent ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex max-h-40 min-h-[60px] w-full resize-none overflow-y-auto rounded-md border px-3 py-2 text-base shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
        />
      </div>
