...
const SPLASH_CRITICAL_CSS = [
  ...
  ".app-splash-brand{display:flex;flex-direction:column;align-items:center;text-align:center}",
  ".app-splash-title{margin:0;font-size:3rem;font-weight:700;letter-spacing:.35em;padding-left:.35em;line-height:1.1;color:#fff}",
  ".app-splash-subtitle{margin:1.5rem 0 0;font-size:.875rem;font-weight:600;letter-spacing:.28em;padding-left:.28em;line-height:1.4;color:rgba(214,227,255,.9)}",
  ".app-splash-blocker-footer,.app-splash-footer{position:absolute;right:0;bottom:0;left:0;display:flex;flex-direction:column;align-items:center;gap:.75rem;padding:0 1rem max(1.5rem,env(safe-area-inset-bottom)) 1rem;box-sizing:border-box}",
